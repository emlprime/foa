# Django settings for foa project.
...
DATABASE_NAME = 'private_foa'             # Or path to database file if using sqlite3.
...
SECRET_KEY = '-af7+y29o18a1-ele8$t5raxcrjcgl3i7j5#n5+2s4bci3z=w1'
